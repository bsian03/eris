...
* @prop {Object} current.options The options for the current stream
...
* // Add current.pausedTime, current.pausedTimestampe, current.playTime, and current.starTime
* @prop {Boolean} ended Whether the stream ended
* @prop {Boolean} playing Whether something is playing
* @prop {Boolean} speaking Whether someone is speaking
* @prop {Number} volume The current volume
*/
