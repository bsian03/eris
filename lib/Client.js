...
class Client extends EventEmitter {
    ...
    */
    addGroupRecipient(groupID, userID) {
        return this.requestHandler.request({
            auth: true,
            method: "PUT",
            url: Endpoints.CHANNEL_RECIPIENT(groupID, userID)
        });
    }
    ...
    */
    addMessageReaction(channelID, messageID, reaction, userID) {
        ...
        return this.requestHandler.request({
            auth: true,
            method: "PUT",
            url: Endpoints.CHANNEL_MESSAGE_REACTION_USER(channelID, messageID, reaction, userID || "@me")
        });
    }
    ...
    */
    addRelationship(userID, block) {
        return this.requestHandler.request({
            ...
            method: "PUT",
            url: Endpoints.USER_RELATIONSHIP("@me", userID)
        });
    }
    ...
    */
    addSelfPremiumSubscription(token, plan) {
        return this.requestHandler.request({
            ...
            method: "PUT",
            url: Endpoints.USER_BILLING_PREMIUM_SUBSCRIPTION("@me")
        });
    }
    ...
    */
    bulkEditCommandPermissions(guildID, permissions) {
        ...
        return this.requestHandler.request({
            ...
            body: permissions,
            method: "PUT",
            url: Endpoints.GUILD_COMMAND_PERMISSIONS(this.application.id, guildID)
        });
    }
    ...
    */
    bulkEditCommands(commands) {
        ...
        return this.requestHandler.request({
            ...
            body: commands,
            method: "PUT",
            url: Endpoints.COMMANDS(this.application.id)
        });
    }
    ...
    */
    bulkEditGuildCommands(guildID, commands) {
        ...
        return this.requestHandler.request({
            ...
            body: commands,
            method: "PUT",
            url: Endpoints.GUILD_COMMANDS(this.application.id, guildID)
        });
    }
    ...
    */
    createInteractionResponse(interactionID, interactionToken, options, file) {
        ...
        return this.requestHandler.request({
            ...
            url: Endpoints.INTERACTION_RESPOND(interactionID, interactionToken)
        });
    }
    ...
    */
    createThreadWithMessage(channelID, messageID, options) {
        return this.requestHandler.request({
            ...
            method: "POST",
            url: Endpoints.THREAD_WITH_MESSAGE(channelID, messageID)
        }).then((channel) => Channel.from(channel, this));
    }
    ...
    */
    createThreadWithoutMessage(channelID, options) {
        return this.requestHandler.request({
            ...
            method: "POST",
            url: Endpoints.THREAD_WITHOUT_MESSAGE(channelID)
        }).then((channel) => Channel.from(channel, this));
    }
    ...
    crosspostMessage(channelID, messageID) {
        return this.requestHandler.request({
            auth: true,
            method: "POST",
            url: Endpoints.CHANNEL_CROSSPOST(channelID, messageID)
        }).then((message) => new Message(message, this));
    }
    ...
    */
    deleteCommand(commandID) {
        ...
        return this.requestHandler.request({
            auth: true,
            method: "DELETE",
            url: Endpoints.COMMAND(this.application.id, commandID)
        });
    }
    ...
    */
    deleteGuildCommand(guildID, commandID) {
        ...
        return this.requestHandler.request({
            auth: true,
            method: "DELETE",
            url: Endpoints.GUILD_COMMAND(this.application.id, guildID, commandID)
        });
    }
    ...
    */
    deleteSelfConnection(platform, id) {
        return this.requestHandler.request({
            auth: true,
            method: "DELETE",
            url: Endpoints.USER_CONNECTION_PLATFORM("@me", platform, id)
        });
    }
    ...
    */
    deleteStageInstance(channelID) {
        return this.requestHandler.request({
            auth: true,
            method: "DELETE",
            url: Endpoints.STAGE_INSTANCE(channelID)
        });
    }
    ...
    */
    deleteUserNote(userID) {
        return this.requestHandler.request({
            auth: true,
            method: "DELETE",
            url: Endpoints.USER_NOTE("@me", userID)
        });
    }
    ...
    */
    deleteWebhook(webhookID, token, reason) {
        return this.requestHandler.request({
            ...
            reason: reason,
            url: token 
                ? Endpoints.WEBHOOK_TOKEN(webhookID, token)
    ...
    */
    deleteWebhookMessage(webhookID, token, messageID) {
        return this.requestHandler.request({
            auth: true,
            method: "DELETE",
            url: Endpoints.WEBHOOK_MESSAGE(webhookID, token, messageID)
        });
    }
    ...
    */
    disableSelfMFATOTP(code) {
        return this.requestHandler.request({
            ...
            body: { code },
            method: "POST",
            url: Endpoints.USER_MFA_TOTP_DISABLE("@me")
        }).then((data) => {
            if(data.token) {
    ...
    */
    editChannelPosition(channelID, position, options = {}) {
        ...
        return this.requestHandler.request({
            ...
            method: "PATCH",
            url: Endpoints.GUILD_CHANNELS(this.channelGuildMap[channelID])
        });
    }
    ...
    */
    editCommandPermissions(guildID, commandID, permissions) {
        ...
        return this.requestHandler.request({
            ...
            body: { permissions },
            method: "PUT",
            url: Endpoints.COMMAND_PERMISSIONS(this.application.id, guildID, commandID)
        });
    }
    ...
    */
    editGuildVoiceState(guildID, options, userID = "@me") {
        return this.requestHandler.request({
            ...
            method: "PATCH",
            url: Endpoints.GUILD_VOICE_STATE(guildID, userID)
        });
    }
    ...
    */
    editMessage(channelID, messageID, content) {
        ...
        return this.requestHandler.request({
            auth: true,
            body: content,
            files: Array.isArray(content.file) ? content.file : [content.file],
            method: "PATCH",
            url: Endpoints.CHANNEL_MESSAGE(channelID, messageID)
        }).then((message) => new Message(message, this));
    }
    ...
    */
    editNickname(guildID, nick, reason) {
        return this.requestHandler.request({
            ...
            method: "PATCH",
            reason: reason,
            url: Endpoints.GUILD_MEMBER_NICK(guildID, "@me")
        });
    }
    ...
    */
    editSelfSettings(data) {
        ...
        return this.requestHandler.request({
            ...
            method: "PATCH",
            url: Endpoints.USER_SETTINGS("@me")
        });
    }
    ...
    */
    enableSelfMFATOTP(secret, code) {
        return this.requestHandler.request({
            ...
            method: "POST",
            url: Endpoints.USER_MFA_TOTP_ENABLE("@me")
        }).then((data) => {
            if(data.token) {
                this._token = data.token;
            }
    ...
    */
    executeSlackWebhook(webhookID, token, options) {
        ...
        return this.requestHandler.request({
            ...
            body: options,
            method: "POST",
            url: Endpoints.WEBHOOK_TOKEN_SLACK(webhookID, token) + (qs ? "?" + qs : "")
        });
    }
    ...
    */
    executeWebhook(webhookID, token, options) {
        ...
        return this.requestHandler.request({
            ...
            files: Array.isArray(options.file) ? options.file : [options.file],
            method: "POST",
            url: Endpoints.WEBHOOK_TOKEN(webhookID, token) + (qs ? "?" + qs : "")
    ...
    followChannel(channelID, webhookChannelID) {
        return this.requestHandler.request({
            ...
            method: "POST",
            url: Endpoints.CHANNEL_FOLLOW(channelID)
        });
    }
    ...
    */
    getActiveGuildThreads(guildID) {
        return this.requestHandler.request({
            auth: true,
            method: "GET",
            url: Endpoints.THREADS_GUILD_ACTIVE(guildID)
        }).then((response) => ({
    ...
    */
    getActiveThreads(channelID) {
        return this.requestHandler.request({
            auth: true,
            method: "GET",
            url: Endpoints.THREADS_ACTIVE(channelID)
        }).then((response) => ({
    ...
    */
    getArchivedThreads(channelID, type, options = {}) {
        return this.requestHandler.request({
            ...
            body: options,
            method: "GET",
            url: Endpoints.THREADS_ARCHIVED(channelID, type)
        }).then((response) => ({
            hasMore: response.has_more,
            members: response.members.map((member) => new ThreadMember(member, this)),
            threads: response.threads.map((thread) => Channel.from(thread, this))
    ...
    */
    getChannelInvites(channelID) {
        return this.requestHandler.request({
            ...
            method: "GET",
            url: Endpoints.CHANNEL_INVITES(channelID)
        }).then((invites) => invites.map((invite) => new Invite(invite, this)));
    }
    ...
    */
    getEmojiGuild(emojiID) {
        return this.requestHandler.request({
            auth: true,
            method: "GET",
            url: Endpoints.CUSTOM_EMOJI_GUILD(emojiID)
    ...
    */
    async getGuildBans(guildID, options = {}) {
        const bans = await this.requestHandler.request({
            auth: true,
            body: {
                after: options.after,
    ...
    */
    getGuildWidgetSettings(guildID) {
        return this.requestHandler.request({
            auth: true,
            method: "GET",
            url: Endpoints.GUILD_WIDGET_SETTINGS(guildID)
        });
    }
    ...
    */
    getJoinedPrivateArchivedThreads(channelID, options = {}) {
        return this.requestHandler.request({
            ...
            body: options,
            method: "GET",
            url: Endpoints.THREADS_ARCHIVED_JOINED(channelID)
        }).then((response) => ({
            hasMore: response.has_more,
            members: response.members.map((member) => new ThreadMember(member, this)),
            threads: response.threads.map((thread) => Channel.from(thread, this))
    ...
    */
    getMessageReaction(channelID, messageID, reaction, options = {}, before, after) {
        ...
        return this.requestHandler.request({
            ...
            body: options,
            method: "GET",
            url: Endpoints.CHANNEL_MESSAGE_REACTION(channelID, messageID, reaction)
    ...
    async getMessages(channelID, options = {}, before, after, around) {
        ...
        if(limit && limit > 100) {
            ...
            const get = async (_before, _after) => {
                const messages = await this.requestHandler.request({
                    auth: true,
                    body: {
                        limit: 100,
    ...
    */
    getOAuthApplication(appID) {
        return this.requestHandler.request({
            auth: true,
            method: "GET",
            url: Endpoints.OAUTH2_APPLICATION(appID || "@me")
        });
    }
    ...
    */
    getPins(channelID) {
        ...
        }).then((messages) => messages.map((message) => new Message(message, this)));
    }
    ...
    */
    getSelfConnections() {
        return this.requestHandler.request({
            auth: true,
            method: "GET",
            url: Endpoints.USER_CONNECTIONS("@me")
        });
    }
    ...
    */
    getSelfMFACodes(password, regenerate) {
        return this.requestHandler.request({
            ...
            method: "GET",
            url: Endpoints.USER_MFA_CODES("@me")
        });
    }
    ...
    */
    getSelfPayments() {
        return this.requestHandler.request({
            auth: true,
            method: "GET",
            url: Endpoints.USER_BILLING_PAYMENTS("@me")
        });
    }
    ...
    */
    getThreadMembers(channelID) {
        return this.requestHandler.request({
            auth: true,
            method: "GET",
            url: Endpoints.THREAD_MEMBERS(channelID)
    ...
    */
    joinThread(channelID, userID = "@me") {
        return this.requestHandler.request({
            auth: true,
            method: "PUT",
            url: Endpoints.THREAD_MEMBER(channelID, userID)
        });
    }
    ...
    * @returns {Promise}
    */
    removeMessageReaction(channelID, messageID, reaction, userID = "@me") {
        if(reaction === decodeURI(reaction)) {
            reaction = encodeURIComponent(reaction);
        }
        ...
        return this.requestHandler.request({
            auth: true,
            method: "DELETE",
            url: Endpoints.CHANNEL_MESSAGE_REACTION_USER(channelID, messageID, reaction, userID)
        });
    }
    ...
    */
    searchChannelMessages(channelID, query) {
        return this.requestHandler.request({
            ...
            method: "GET",
            url: Endpoints.CHANNEL_MESSAGES_SEARCH(channelID)
        }).then((results) => ({
    ...
    */
    searchGuildMessages(guildID, query) {
        return this.requestHandler.request({
            ...
            method: "GET",
            url: Endpoints.GUILD_MESSAGES_SEARCH(guildID)
        }).then((results) => ({
            results: results.messages && results.messages.map((result) => result.map((message) => new Message(message, this))),
            totalResults: results.total_results
        }));
    ...
    */
    validateDiscoverySearchTerm(term) {
        return this.requestHandler.request({
            auth: true,
            method: "GET",
            url: Endpoints.DISCOVERY_VALIDATION + `?term=${encodeURI(term)}`
        });    
    }
